...
$file_path = file_get_contents("./lang/$lang/locales.json");

$locales = json_decode($file_path);
...
<body class="is-boxed has-animations">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title h2-mobile mt-0 is-revealing"><?= $locales->welcome_message ?></h1>
                            <p class="hero-paragraph is-revealing"><?= $locales->desc_message ?></p>
                            <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" href="#"><?= $locales->button ?></a></p>
                        </div>
                        ...
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile"><?= $locales->feature1 ?></h4>
                                    <p class="text-sm"><?= $locales->feature1_desc ?></p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile"><?= $locales->feature2 ?></h4>
                                    <p class="text-sm"><?= $locales->feature2_desc ?></p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile"><?= $locales->feature3 ?></h4>
                                    <p class="text-sm"><?= $locales->feature3_desc ?></p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile"><?= $locales->feature4 ?></h4>
                                    <p class="text-sm"><?= $locales->feature4_desc ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="pricing section">
                ...
                <div class="container">
                    <div class="pricing-inner section-inner has-top-divider">
                        <h2 class="section-title mt-0 text-center"><?= $locales->pricing_header ?></h2>
                        <div class="pricing-tables-wrap">
                            <div class="pricing-table">
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?= $locales->starter ?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2">27</span></div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <li class="is-revealing">
                                                ...
                                                <span><?= $locales->starter_point1 ?> </span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->starter_point2 ?>  </span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->starter_point3 ?>  </span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-table-cta is-revealing">
                                        <a class="button button-primary button-shadow button-block" href="#"><?= $locales->get_button ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="pricing-table">
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?= $locales->professional ?> </div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2">97</span></div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                ...
                                                <span><?= $locales->professional_point1 ?> </span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->professional_point2 ?></span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->professional_point3 ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-table-cta is-revealing">
                            ...
                            <div class="pricing-table">
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?= $locales->business ?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2">147</span></div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                ...
                                                <span><?= $locales->business_point1 ?></span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->business_point2 ?></span>
                                            </li>
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span><?= $locales->business_point3 ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pricing-table-cta is-revealing">
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="footer-copyright">&copy; 2018 Webtech, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script>
        const lang_option = document.getElementById('lang');
        let lang = window.location.search.split('=')[1];
        if (lang) {
            lang_option.value = lang
        } else {
            lang_option.value = 'en'
        }
        function handleLang() {
            window.location = "index.php?lang=" + lang_option.value;
        }
    </script>
</body>
</html>
